describe('Abas - Teste de abas', () => {
  ...
  it('Mudança para pesquisa por vacina', function() {
    ...
    // Assertion
    cy.get('div.empty-message > span').should('have.text', 'Selecione os filtros desejados para iniciar a visualização dos dados');
    ...
    cy.get('h2.main-title')
      .should('have.text', 'Cobertura vacinal de Febre Amarela por estado em 2000');

    cy.get('h3.sub-title')
      .should('have.text', '1ª dose para menores de 1 ano');
  });
})
