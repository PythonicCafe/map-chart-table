...
const stubs = {
    ...
    FilterSuggestion: {
        template: '<div data-testid="filter-suggestion-stub">Suggestion</div>',
    },
    Map: { template: '<div data-testid="map-stub">Map Component</div>' },
    SubSelect: {
        template:
            '<div data-testid="sub-select-stub">SubSelect Component</div>',
    },
    Table: { template: '<div data-testid="table-stub">Table Component</div>' },
    SubButtons: {
        template:
            '<div data-testid="sub-buttons-stub">SubButtons Component</div>',
    },
}
...
describe('<MainCard />', () => {
    ...
    it('deve renderizar o layout Desktop por padrão (> 1368px)', () => {
        ...
        cy.get('.sub-select-container')
            .find('[data-testid="sub-select-stub"]')
            .should('exist')
    })
