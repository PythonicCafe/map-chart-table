...
describe('<SubSelect />', () => {
    const mountWithStore = (props = {}, customContentState = {}) => {
        const SubSelectAsync = defineAsyncComponent(
            () => import('@/components/main/card-components/sub-select')
        )
    ...
    it('deve desabilitar campos quando yearSlideAnimation for true', () => {
        ...
        cy.get('[data-test="select-doenca"] .n-base-selection').should(
            'have.class',
