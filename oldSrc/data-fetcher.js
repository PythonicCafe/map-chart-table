export class DataFetcher {
  ...
  async requestDataInBody(endPoint, options = {}, apiPoint = "/wp-json/api/v1/") {
    const { signal, body, method = 'GET', headers: customHeaders = {} } = options;
    ...
    try {
      ...
      Object.keys(fetchOptions).forEach(key => fetchOptions[key] === undefined && delete fetchOptions[key]);
